            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-2.5 pr-11 text-white placeholder-white/30 focus:outline-none focus:border-emerald-500/50"
                />
