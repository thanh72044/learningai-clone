...
/** 2026 AI Agent Program — 3 modules with combo offer */
    ...
    <section className="py-20 bg-emerald-950/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {MODULES.map((mod) => (
            <Card key={mod.id} className={`p-6 flex flex-col gap-4 bg-gradient-to-br ${mod.color}`}>
        ...
        {/* Combo offer */}
        <div className="rounded-2xl border border-yellow-400/30 bg-yellow-400/5 p-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
